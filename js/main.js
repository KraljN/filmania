...
let messageText  = "This field can't be empty"
...
let nameValidno, lastNameValidno, emailValidno, numberValidno, meessageValidno;


nameValidno = proveraTb(name, regExpName, nameText);
lastNameValidno = proveraTb(lastName, regExpLastName, lastNameText);
emailValidno = proveraTb(mail, regExpMail, mailText);
numberValidno = proveraTb(number, regExpNumber, numberText);
meessageValidno = proveraTextArea(message, messageText);

    if(nameValidno && lastNameValidno && emailValidno && numberValidno && meessageValidno){
        $.ajax({
            type: "POST",
            url: "obrada.php",
            data: {
...
function proveraTextArea(polje, text){
